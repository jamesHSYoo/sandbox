...
int main()
{
    ...
    cout << "Pointer approach" << endl;

    cout << "lotto + 0 : " << lotto + 0 << endl;
    cout << "lotto + 1 : " << lotto + 1 << endl;
    cout << "lotto + 2 : " << lotto + 2 << endl;
    cout << "lotto + 3 : " << lotto + 3 << endl;
    cout << "lotto + 4 : " << lotto + 4 << endl;
    cout << "lotto + 5 : " << lotto + 5 << endl;
    cout << "lotto + 6 : " << lotto + 6 << endl;
